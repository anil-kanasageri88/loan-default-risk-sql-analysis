...
-- Database: MySQL (loan_default_db)
-- ============================================================================
-- Run this AFTER generate_data_mysql.py has created and populated the database.
-- In MySQL Workbench: USE loan_default_db;  then run each query below.
-- ============================================================================
...
WITH monthly_stats AS (
    SELECT
        DATE_FORMAT(disbursed_date, '%Y-%m') AS disbursed_month,
